...
Future<void> deleteAccount({
  ...
  try {
    print("Starting deleteAccount for user: $id");
    SharedPreferences preferences = await SharedPreferences.getInstance();
    ...
    print("Sending DELETE request to: $uri/api/user/delete-account/$id");
    ...
    manageHttpResponse(
      ...
      context: context,
      onSuccess: () async {
        print("User deleted, clearing storage and navigating back");
        await preferences.remove('auth_token');
        await preferences.remove('user');
        ref.read(userProvider.notifier).signOut();
